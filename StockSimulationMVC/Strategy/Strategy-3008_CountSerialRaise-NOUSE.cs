...
{
    public class Strategy_3008_CountSerialRaise: IStrategy
    {
        ...
        public Strategy_3008_CountSerialRaise(Hashtable Setup)
        {
            try
            {
        ...
        public Strategy_3008_CountSerialRaise() { }
        ...
        public bool SellCondition(ref SimulationVariable simulationVariable, ref DataList dataList, ref BasicFinancialReportListModel financialdata, int j)
        {
            ...
            if (
                ...
                || simulationVariable.Accumulation < -StopLossAndRaise
                || (dataList.TechData[j].ClosePrice< dataList.TechData[j].OpenPrice && simulationVariable.Accumulation>0)
                 )
            {
                CountRaiseDays = 0;
                return true;
